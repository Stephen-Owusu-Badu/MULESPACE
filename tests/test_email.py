...
class TestEmailFunctions:
    ...
    @patch("app.email.mail")
    def test_send_registration_confirmation_with_description(
        self, mock_mail, app, student_user, event
    ):
    ...
    def test_send_email_multiple_recipients(self, mock_mail, app):
        ...
        with app.app_context():
            ...
            send_email(
                subject="Test", recipients=recipients, text_body="Body", html_body="<p>HTML</p>"
            )
            assert mock_mail.send.called
